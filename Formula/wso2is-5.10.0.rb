class Wso2is5100 < Formula
  desc "WSO2 Identity Server 5.10.0"
  homepage "https://wso2.com/api-management/"
  url "https://dl.bintray.com/wso2/binary/wso2is-5.10.0.zip"
  sha256 "4a2c14c7eec2d9997e24ede6d49f0b5729d15bc6e3feaff6d27defca4018754b"
...
#  depends_on :java => "11"
  ...
  def install
    ...
    puts "\nIMPORTANT: After WSO2 Identity Server 5.10.0 is successfully installed, Instigate any improvements on top of a released WSO2 product version by running In-Place Updates tool."
